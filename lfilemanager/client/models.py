...
class Notificacion(models.Model):
    ...
    oid_usuario = models.ForeignKey(Usuario, on_delete=models.CASCADE, db_column='oid_usuario', null=True, blank=True)
    titulo = models.CharField(max_length=150)
    mensaje = models.TextField()
    tipo = models.CharField(max_length=30, default='in-app') # Ej: in-app, email
